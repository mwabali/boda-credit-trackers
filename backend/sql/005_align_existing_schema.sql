ALTER TABLE riders
  ...
  ADD COLUMN IF NOT EXISTS updated_at VARCHAR(64) NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE stations
  ADD COLUMN IF NOT EXISTS company_name VARCHAR(100) NOT NULL DEFAULT 'Total',
...
ALTER TABLE transactions
  ...
  ADD COLUMN IF NOT EXISTS payment_date VARCHAR(64),
